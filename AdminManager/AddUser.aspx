<%@ Page Title="Add User" Language="C#" MasterPageFile="~/AdminManager/BackAdmin.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="Food_Ordering_Mangment.AdminManager.AddUser" %>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-container">
                    ...
                    <br />
                    <asp:CheckBox ID="chkIsPasswordConfirmed" runat="server" Text="Is Password Confirmed" />
                    <br />
            ...
            <div class="col-lg-8">
                <div class="table-container">
                    ...
                    <h2>Manage Users</h2>
                    <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" GridLines="None" ShowHeaderWhenEmpty="True" EmptyDataText="No users found.">
                        <Columns>
                            ...
                            <asp:BoundField DataField="IsPasswordConfirmed" HeaderText="Is Password Confirmed" />
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <div class="action-icons">
                                        <a href="AddUser.aspx?UserId=<%# Eval("UserId") %>" title="Edit">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="AddUser.aspx?UserId=<%# Eval("UserId") %>&action=delete" title="Delete" onclick="return confirm('Are you sure you want to delete this user?');">
